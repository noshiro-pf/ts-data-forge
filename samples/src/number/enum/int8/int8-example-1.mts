...
// Boundary handling
const overflow = Int8.add(127, 10); // Int8 (127) - clamped
const underflow = Int8.sub(-128, 10); // Int8 (-128) - clamped

// Utility operations
const clamped = Int8.clamp(200); // Int8 (127)
const absolute = Int8.abs(-100); // Int8 (100)
const minimum = Int8.min(a, b); // Int8 (50)
const maximum = Int8.max(a, b); // Int8 (100)

// Random generation
const die = Int8.random(1, 6); // Random 1-6
const offset = Int8.random(-10, 10); // Random ±10
