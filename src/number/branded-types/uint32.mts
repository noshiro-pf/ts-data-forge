 ...
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/uint32/asuint32-example-1.mts|Sample code}.
 */
 ...
 *
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/uint32/uint32-example-1.mts|Sample code}.
 */
export const Uint32 = {
  /**
   ...
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/uint32/uint32-example-2.mts|Sample code 2}.
   */
  clamp,
   ...
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/uint32/uint32-example-3.mts|Sample code 3}.
   */
  pow,
   ...
   * @returns `a + b` as a Uint32, clamped to valid range
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/uint32/uint32-example-4.mts|Sample code 4}.
   */
  add,
   ...
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/uint32/uint32-example-5.mts|Sample code 5}.
   */
  sub,
   ...
   * @param b - Second Uint32
   * @returns `a * b` as a Uint32, clamped to valid range
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/uint32/uint32-example-6.mts|Sample code 6}.
   */
  mul,
   ...
   * @returns `⌊a / b⌋` as a Uint32, clamped to valid range
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/uint32/uint32-example-7.mts|Sample code 7}.
   */
  div,
} as const;
