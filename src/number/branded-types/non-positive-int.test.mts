...
describe('NonPositiveInt test', () => {
  ...
  describe('NonPositiveInt.clamp', () => {
    ...
    test('clamps infinity to 0', () => {
      expect(NonPositiveInt.clamp(Number.POSITIVE_INFINITY)).toBe(0);
    });
  });
  ...
  describe('NonPositiveInt.mul', () => {
    test('multiplies two non-positive integers', () => {
      expect(NonPositiveInt.mul(-5, -3)).toBe(-15);

      expect(NonPositiveInt.mul(-5, 0)).toBe(0);

      expect(NonPositiveInt.mul(0, -5)).toBe(0);
    });
  });
