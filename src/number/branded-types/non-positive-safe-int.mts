...
export const NonPositiveSafeInt = {
  ...
  /**
   * Multiplies two NonPositiveSafeInt values.
   *
   * @param a The first NonPositiveSafeInt.
   * @param b The second NonPositiveSafeInt.
   * @returns `a * b` clamped to [Number.MIN_SAFE_INTEGER, 0] as a
  ...
  /**
   * Divides one NonPositiveSafeInt by another using floor division.
   *
   * @param a The dividend NonPositiveSafeInt.
   * @param b The divisor NonPositiveSafeInt.
   * @returns `⌊a / b⌋` clamped to [Number.MIN_SAFE_INTEGER, 0] as a
   *   NonPositiveSafeInt.
   */
  div,
