 ...
 *
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/positive-int/is-positive-int-example.mts|Sample code}.
 */
 ...
 *
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/positive-int/as-positive-int-example.mts|Sample code}.
 */
...
export const PositiveInt = {
   ...
   *
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/positive-int/min-example.mts|Sample code}.
   */
  min: min_,
   ...
   *
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/positive-int/max-example.mts|Sample code}.
   */
  max: max_,
   ...
   *
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/positive-int/clamp-example.mts|Sample code}.
   */
  clamp,
   ...
   *
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/positive-int/random-example.mts|Sample code}.
   */
  random,
   ...
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/positive-int/pow-example.mts|Sample code}.
   */
  pow,
   ...
   * @returns `a + b` as a PositiveInt, but never less than 1
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/positive-int/add-example.mts|Sample code}.
   */
  add,
   ...
   *
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/positive-int/sub-example.mts|Sample code}.
   */
  sub,
   ...
   * @param b - Second positive integer
   * @returns `a * b` as a PositiveInt, but never less than 1
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/positive-int/mul-example.mts|Sample code}.
   */
  mul,
   ...
   * @returns `max(1, ⌊a / b⌋)` as a PositiveInt
   *
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/number/branded-types/positive-int/div-example.mts|Sample code}.
   */
  div,
} as const;
