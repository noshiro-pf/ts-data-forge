 ...
 *
 * ### Basic Type Testing
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/expect-type/expecttype-example-1.mts|Sample code}.
 *
 * ### Array and Tuple Type Validation
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/expect-type/expecttype-example-2.mts|Sample code 2}.
 *
 * ### Function Return Type Testing
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/expect-type/expecttype-example-3.mts|Sample code 3}.
 *
 * ### Union and Intersection Types
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/expect-type/expecttype-example-4.mts|Sample code 4}.
 *
 * ### Branded Type Validation
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/expect-type/expecttype-example-5.mts|Sample code 5}.
 *
 * ### Optional and Result Type Testing
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/expect-type/expecttype-example-6.mts|Sample code 6}.
 *
 * ### Type Guard and Validation Testing
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/expect-type/expecttype-example-7.mts|Sample code 7}.
 *
 ...
 *
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/expect-type/expecttype-example-8.mts|Sample code 8}.
 *
 * ### Type Relationship Validation
 * Test complex type hierarchies and relationships:
 *
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/expect-type/expecttype-example-9.mts|Sample code 9}.
 *
 * ## Important Notes
 *
