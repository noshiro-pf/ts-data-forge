 ...
 *
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/collections/imap-mapped/imap-mapped-example-1.mts|Sample code}.
 */
 ...
 * @template KM The type of the mapped primitive keys (string, number, etc.).
 *
 * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/collections/imap-mapped/imapmapped-example-1.mts|Sample code}.
 */
...
export namespace IMapMapped {
   ...
   *
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/collections/imap-mapped/create-example-1.mts|Sample code}.
   */
   ...
   *
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/collections/imap-mapped/equal-example-1.mts|Sample code}.
   */
