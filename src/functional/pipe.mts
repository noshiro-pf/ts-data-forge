...
type PipeBase<A> = Readonly<{
   ...
   *
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/functional/pipe/pipe-map-example.mts|Sample code}.
   */
   ...
   *
   * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/functional/pipe/pipe-map-nullable-example.mts|Sample code}.
   */
...
type PipeWithMapOptional<A extends Optional.Base> = MergeIntersection<
  PipeBase<A> &
    Readonly<{
       ...
       *
       * @see {@link https://github.com/noshiro-pf/ts-data-forge/blob/main/samples/src/functional/pipe/pipe-map-optional-example.mts|Sample code}.
       */
